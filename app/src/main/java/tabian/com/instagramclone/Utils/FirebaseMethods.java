...
public class FirebaseMethods {
    ...
    public void uploadNewPhoto(String photoType, final String caption, int imgCount, final String imgUrl,Bitmap bm) {
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            byte[] bytes = ImageManager.getBytesFromBitmap(bm,60);
